...
def extract_room_price(page, hotel_name, hotel_loc, list_facilities, other_information, latitude,longitude, extraction_date, effective_date):
    """
    Example output : 
    [
        {
    ...
    for i in range(type_room.count()):
        ...
        price_tipe = type_room.nth(i).locator('div[data-element-name="child-room-item"]').last
